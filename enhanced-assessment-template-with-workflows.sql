-- Enhanced Assessment Template with Workflow Mapping
-- Adds workflow analysis questions to strategic section while preserving AI dimension scoring
  ...
  "strategic": {
    ...
    "questions": [
      ...
      },
      {
        ...
        "text": "Which of these processes are you directly involved with in your work? (Select all that apply)",
        "type": "multi_select",
        "allowMultiple": true,
        "tags": ["workflow_mapping"],
        "options": [
          { "id": "customer_onboarding", "label": "Customer onboarding and account setup", "value": "customer_onboarding" },
          { "id": "customer_support", "label": "Customer support and issue resolution", "value": "customer_support" },
          { "id": "invoice_processing", "label": "Invoice processing and payment handling", "value": "invoice_processing" },
          { "id": "contract_management", "label": "Contract review and management", "value": "contract_management" },
          { "id": "recruitment", "label": "Employee recruitment and hiring", "value": "recruitment" },
          { "id": "employee_onboarding", "label": "Employee onboarding and training", "value": "employee_onboarding" },
          { "id": "performance_management", "label": "Performance reviews and management", "value": "performance_management" },
          { "id": "content_creation", "label": "Marketing content creation and campaigns", "value": "content_creation" },
          { "id": "sales_process", "label": "Sales prospecting and lead management", "value": "sales_process" },
          { "id": "data_analysis", "label": "Data analysis and reporting", "value": "data_analysis" },
          { "id": "project_management", "label": "Project planning and management", "value": "project_management" },
          { "id": "maintenance_operations", "label": "Equipment/facility maintenance", "value": "maintenance_operations" },
          { "id": "compliance_monitoring", "label": "Compliance monitoring and reporting", "value": "compliance_monitoring" },
          { "id": "quality_assurance", "label": "Quality assurance and testing", "value": "quality_assurance" },
          { "id": "inventory_management", "label": "Inventory and supply chain management", "value": "inventory_management" },
          { "id": "other_process", "label": "Other business process", "value": "other_process" }
        ]
      },
      {
        "id": "daily_work_breakdown",
        "text": "Approximately what percentage of your time is spent on these types of activities? (Total should equal 100%)",
        "type": "slider_group",
        "tags": ["workflow_mapping"],
        "options": [
          { "id": "communication", "label": "Email, meetings, coordination", "min": 0, "max": 100, "step": 5 },
          { "id": "data_processing", "label": "Reviewing, entering, or analyzing data", "min": 0, "max": 100, "step": 5 },
          { "id": "document_work", "label": "Creating, reviewing, or processing documents", "min": 0, "max": 100, "step": 5 },
          { "id": "customer_interaction", "label": "Direct customer/client interaction", "min": 0, "max": 100, "step": 5 },
          { "id": "strategic_planning", "label": "Planning, strategy, decision-making", "min": 0, "max": 100, "step": 5 },
          { "id": "hands_on_work", "label": "Hands-on technical or operational work", "min": 0, "max": 100, "step": 5 }
        ]
      },
      {
        "id": "process_bottlenecks",
        "text": "What are the biggest bottlenecks or time-wasters in your main work processes? (Select all that apply)",
        "type": "multi_select",
        "allowMultiple": true,
        "tags": ["workflow_mapping"],
        "options": [
          { "id": "waiting_approvals", "label": "Waiting for approvals or responses from others", "value": "waiting_approvals" },
          { "id": "manual_data_entry", "label": "Manual data entry or copying between systems", "value": "manual_data_entry" },
          { "id": "finding_information", "label": "Finding information in documents or systems", "value": "finding_information" },
          { "id": "repetitive_communication", "label": "Repetitive emails or explanations", "value": "repetitive_communication" },
          { "id": "document_formatting", "label": "Formatting documents or presentations", "value": "document_formatting" },
          { "id": "scheduling_coordination", "label": "Scheduling and coordination tasks", "value": "scheduling_coordination" },
          { "id": "quality_checking", "label": "Reviewing and checking others'' work", "value": "quality_checking" },
          { "id": "report_generation", "label": "Creating routine reports or summaries", "value": "report_generation" },
          { "id": "system_limitations", "label": "Working around system limitations", "value": "system_limitations" },
          { "id": "context_switching", "label": "Switching between multiple tools/systems", "value": "context_switching" }
        ]
      },
      {
        "id": "automation_readiness",
        "text": "How much of your routine work could potentially be automated with the right tools?",
        "type": "radio",
        "tags": ["workflow_mapping"],
        "options": [
          { "id": "very_little", "label": "Very little (0-10%) - Most of my work requires human judgment", "value": "very_little" },
          { "id": "some_tasks", "label": "Some tasks (10-30%) - A few repetitive tasks could be automated", "value": "some_tasks" },
          { "id": "significant_portion", "label": "Significant portion (30-60%) - Many routine tasks could be automated", "value": "significant_portion" },
          { "id": "majority", "label": "Majority (60%+) - Most of my work is routine and could be automated", "value": "majority" }
        ]
      },
      {
        "id": "tools_allowed_at_work",
        "text": "Which AI tools are you allowed to use for work-related tasks?",
        "type": "multi_select",
        "allowMultiple": true,
        "tags": ["workflow_mapping"],
        "options": [
          { "id": "microsoft_copilot", "label": "Microsoft Copilot (Office 365)", "value": "microsoft_copilot" },
          { "id": "chatgpt_enterprise", "label": "ChatGPT Enterprise/Business", "value": "chatgpt_enterprise" },
          { "id": "claude_enterprise", "label": "Claude for Work/Enterprise", "value": "claude_enterprise" },
          { "id": "google_workspace_ai", "label": "Google Workspace AI (Bard, Duet)", "value": "google_workspace_ai" },
          { "id": "company_specific_ai", "label": "Company-specific AI tools", "value": "company_specific_ai" },
          { "id": "approved_list", "label": "Other approved AI tools", "value": "approved_list" },
          { "id": "any_tool", "label": "No restrictions - I can use any AI tool", "value": "any_tool" },
          { "id": "none_allowed", "label": "No AI tools are allowed for work", "value": "none_allowed" },
          { "id": "unclear_policy", "label": "Company policy is unclear", "value": "unclear_policy" }
        ]
      },
      {
        "id": "current_automation_level",
        "text": "How automated are your main work processes currently?",
        "type": "radio",
        "tags": ["workflow_mapping"],
        "options": [
          { "id": "fully_manual", "label": "Fully manual - everything done by hand", "value": "fully_manual" },
          { "id": "basic_tools", "label": "Basic tools - using Excel, email, standard software", "value": "basic_tools" },
          { "id": "some_automation", "label": "Some automation - workflows, templates, or simple automations", "value": "some_automation" },
          { "id": "highly_automated", "label": "Highly automated - integrated systems with minimal manual work", "value": "highly_automated" }
        ]
      }
    ]
  },
